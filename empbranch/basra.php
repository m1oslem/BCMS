...
<body>
    <div class="container">
        ...
        <div class="thumbnails">
            <!-- كاميرا 1 -->
            <div class="thumbnail">
                <img id="camera14" src="http://172.16.19.204/camera_14/mjpeg-stream" alt="كاميرا 14">
                <div class="overlay">
            ...
            <!-- كاميرا 2 -->
            <div class="thumbnail">
                <img id="camera15" src="http://172.16.19.204/camera_15/mjpeg-stream" alt="كاميرا 15">
                <div class="overlay">
        ...
        <div class="thumbnails">
            <!-- كاميرا 3 -->
            <div class="thumbnail">
                <img id="camera111" src="http://172.16.19.204/camera_111/mjpeg-stream" alt="كاميرا 111">
                <div class="overlay">
            ...
            <!-- كاميرا 4 -->
            <div class="thumbnail">
                <img id="camera12" src="http://172.16.19.204/camera_12/mjpeg-stream" alt="كاميرا 12">
                <div class="overlay">
            ...
            <!-- كاميرا 5 -->
            <div class="thumbnail">
                <img id="camera13" src="http://172.16.19.204/camera_13/mjpeg-stream" alt="كاميرا 13">
                <div class="overlay">
