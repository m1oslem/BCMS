...
<body>
    <div class="container">
        ...
        <div class="thumbnails">
            <!-- كاميرا 1 -->
            <div class="thumbnail">
                <img id="camera14" src="http://172.16.19.203/camera_5/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
            ...
            <!-- كاميرا 2 -->
            <div class="thumbnail">
                <img id="camera15" src="http://172.16.19.203/camera_6/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
