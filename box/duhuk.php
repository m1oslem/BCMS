...
<body>
    <div class="container">
        ...
        <div class="thumbnails">
            <!-- كاميرا 1 -->
            <div class="thumbnail">
                <img id="camera14" src="http://172.16.19.203/camera_18/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
            ...
            <!-- كاميرا 2 -->
            <div class="thumbnail">
                <img id="camera15" src="http://172.16.19.203/camera_19/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
...
<p></p>
        <div class="thumbnails">
            <!-- كاميرا 3 -->
            <div class="thumbnail">
                <img id="camera111" src="http://172.16.19.204/camera_111/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
                    <button onclick="toggleFullscreen('camera111')">تكبير</button>
                </div>
            </div>

            <!-- كاميرا 4 -->
            <div class="thumbnail">
                <img id="camera12" src="http://172.16.19.204/camera_12/mjpeg-stream" alt="اتصال ضعيف">
                <div class="overlay">
                    <button onclick="toggleFullscreen('camera12')">تكبير</button>
                </div>
            </div>

            <!-- كاميرا 5 -->
            <div class="thumbnail">
                <img id="camera13" src="http://172.16.19.204/camera_13/mjpeg-stream" alt="اتصال ضعيف">
                <div class="overlay">
                    <button onclick="toggleFullscreen('camera13')">تكبير</button>
                </div>
            </div>
        </div>
