...
<body>
    <div class="container">
        ...
        <div class="thumbnails">
            <!-- كاميرا 1 -->
            <div class="thumbnail">
                <img id="camera14" src="http://172.16.19.203/camera_15/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
            ...
            <!-- كاميرا 2 -->
            <div class="thumbnail">
                <img id="camera15" src="http://172.16.19.203/camera_16/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
...
<p></p>
        <div class="thumbnails">
            <!-- كاميرا 3 -->
            <div class="thumbnail">
                <img id="camera111" src="http://172.16.19.203/camera_17/mjpeg-stream" alt="اتصال ضعيف ">
                <div class="overlay">
