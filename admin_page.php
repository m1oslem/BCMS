...
<body>
    ...
    <div class="container">
        ...
        <p>        اختر الصفحة التي ترغب في زيارتها        </p>
        <button onclick="window.open('emp.php', '_blank')">الصفحة الخاصة بالموظفين</button>
        <button onclick="window.open('mangers.php', '_blank')">الصفحة الخاصة بالمدراء</button>
        <button onclick="window.open('box.php', '_blank')">الصفحة الخاصة بالصناديق</button>
        <button onclick="window.open('safes.php', '_blank')">الصفحة الخاصة بالغرف المحصنة</button>
        <button onclick="window.open('admin.php', '_blank')">إدارة المستخدمين</button>
